...
export default function signUp() {
  return (
    <>
      ...
      <div className="signUp w-full h-full flex absolute items-center justify-center">
        <div className="signUpArea flex flex-col items-center">
          ...
          <span className="toLogin mt-[24px] sm:w-[392px] flex justify-center text-[#525866]">
            Hesabınız yok mu?
            <a className="text-[#0a0d14] flex gap-1 items-center ml-[4px] hover:underline" href="/login">
              Giriş Yap
