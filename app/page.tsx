        ...
        <div className="main-page sm:flex sm:flex-row sm:justify-between flex flex-col items-center sm:items-start sm:mx-[80px]">
          <div className="cards w-full">
            <div className="tabs sm:mr-5 flex rounded-[100px] bg-[#f6f8fa] p-[4px] mb-[16px]">
              ...
              <Tab TabSVGS={[
                <svg key="0"className="mr-[8px] min-h-[20px] min-w-[20px]" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg key="1" className="mr-[8px]  min-h-[20px]  min-w-[20px] h-[20px] w-[20px]" width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg key="2" width="20" className="fillsvg min-h-[20px]  min-w-[20px] mr-[8px] fill-[#868c98]" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg key="3" className="fillsvg mr-[8px] min-h-[20px]  min-w-[20px] fill-[#868c98]" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              ]} TabTitles={["Internet Cafe", "Playstation Cafe", "Simulasyon Cafe", "VR Cafe"]} defaultTab={0} a={setactivetab} />
            </div>
