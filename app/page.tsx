      ...
      <main>
        ...
        <div className="topComponent justify-between flex px-[80px] max-[600px]:px-0 py-[20px] items-center relative mb-[12px] after:content-[''] after:w-full after:h-px after:bg-[#e2e5e8] after:absolute after:bottom-0 after:left-0">
          ...
          <div className="search relative border-[1px] border-[solid] border-[#e5e7eb] flex sm:pl-[24px] py-2 pl-2 rounded-[100px] items-center  before:top-[6px]  sm:before:top-[14px] before:left-[95px] sm:before:left-[122px] before:content-[''] before:absolute before:bg-[#e5e7eb] before:h-[24px] before:w-px">
            ...
            <select className="text-sm w-[89px]  sm:mr-[20px]  mr-2 cursor-pointer font-medium s sm:my-[8px] appearance-none outline-0 bg-transparent border-[0PX] max-[600px]:m-0" onChange={(e: any) => setCity(e.target.value)} name="il" id="il">
        ...
        <div className="main-page sm:flex sm:flex-row sm:justify-between flex flex-col items-center sm:mx-[80px]">
          <div className="cards w-full">
            <div className="tabs sm:mr-5 flex rounded-[100px] bg-[#f6f8fa] p-[4px] mb-[16px]">
              <Tab defaultTab={0} a={setactivetab}>
                ...
                <div>
                  <svg className="mr-[8px] h-[20px] w-[20px]" width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <svg width="20" className="fillsvg mr-[8px] fill-[#868c98]" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="">
                  <svg className="fillsvg mr-[8px] fill-[#868c98]" width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
