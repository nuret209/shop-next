...
const TopComponent = () => {
  const { timeId, setTimeId, username } = useContext(DasboardContext);
  return (
    <div className="py-5 bg-white md:px-[109px] gap-2 flex after:content-[''] justify-center md:justify-between  flex-wrap relative after:absolute after:h-[1px] after:w-full after:bg-[#e3e4e8] after:bottom-0 after:right-0">
      <div className="flex">
