...
const SupportLine = () => {
    return (
        <div> <div className='bg-white rounded-2xl [box-shadow:0px_1px_2px_rgba(228,_229,_231,_0.24)] px-5 py-4 border border-[#E2E4E9] text-[#525866] w-[340px] md:w-[392px] h-[178px] flex flex-col justify-between'>
